   ...
   begin
    ...
    when others then
     ...
     begin
      ...
      for v in (select t.buy_user_id,t.TX_MONEY,t.TX_CAIJIN  from  T_XINSHUI_ORDER  t  where  t.product_id=c2cId and t.pay_status='2') loop
            ...
            --产生解冻日志
            insert into T_VA_FROZEN_LOG(FROZEN_ID,TX_USER_ID,Frozen_Money,Frozen_Mosaic_Goldmoney,Frozen_Date,MEMO)
            values(SEQ_VA_FROZEN_LOG_ID.Nextval,orderUserId,txMoney,txCaijin,sysdate,'心水关闭');
