...
public class Windraw14DuplexAction extends BaseAction {

	private static final long serialVersionUID = 8544423397620677843L;
	...
	public String windraw14Duplex() {
		try {
			Map params = canyuBuyService.loadSingle14OrderInfo(betId);
