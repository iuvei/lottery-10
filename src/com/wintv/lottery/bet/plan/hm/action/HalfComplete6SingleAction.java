...
public class HalfComplete6SingleAction extends BaseAction  {

	private static final long serialVersionUID = -4279478734374081474L;
	...
	public String halfComplete6Single() {
		try {
			Map params = canyuBuyService.loadHalfComplete6Info(betId);
