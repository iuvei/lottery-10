...
public class Goal4SingleAction extends BaseAction  {

	private static final long serialVersionUID = -1977392420015423996L;
	...
	public String goal4Single() {
		try {
			Map params = canyuBuyService.loadGoal4Info(betId);
